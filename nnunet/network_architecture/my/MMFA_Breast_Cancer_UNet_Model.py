...
from nnunet.network_architecture.my.neural_network3_breast import SegmentationNetwork
import torch.nn.functional
from nnunet.network_architecture.my.CFSG import CFSG
...
class Generic_UNet_Decoder(nn.Module):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        self.modality_feature_align_modules.append(CFSG(base_num_features,base_num_features,False))
        self.modality_feature_align_modules.append(CFSG(2*base_num_features,2*base_num_features,False))
        self.modality_feature_align_modules.append(CFSG(4*base_num_features,4*base_num_features,False))
        self.modality_feature_align_modules.append(CFSG(8*base_num_features,8*base_num_features,False))
        self.modality_feature_align_modules.append(CFSG(16*base_num_features,16*base_num_features,False))
        self.modality_feature_align_modules.append(CFSG(20*base_num_features,20*base_num_features,False))
    ...
    def forward(self, skip):
        ...
        for j in range(len(DCE_modality_features)):
            ...
            cfsg = self.modality_feature_align_modules[len(DCE_modality_features)-1-j]
            out = cfsg(DCE_conv_output,T2_conv_output)
            skips.append(out)
...
class MMFA_Breast_Cancer_UNet_Model(SegmentationNetwork):
    ...
    def forward(self, x):
        ...
        ##############################################################################
        attention_maps = self.sigmod(torch.stack(attention_maps, 1))
