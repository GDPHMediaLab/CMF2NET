...
import sys
sys.path.append('/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/CMF2Net')
import random
...
def main():
    ...
    parser.add_argument("--task",required=True, help="can be task name or task id")
    parser.add_argument("--fold", required=True,default='',help='0, 1, ..., 5 or \'all\'')
